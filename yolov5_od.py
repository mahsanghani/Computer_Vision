...
Original file is located at
    https://colab.research.google.com/drive/1YEBjFrdgnypnq0MauwtcCYfDZLS7gEVI
...
rf = Roboflow(api_key="0a4WwzoVWX7OLQHdybod", model_format="yolov5", notebook="roboflow-yolov5")
...
!curl -L "https://public.roboflow.com/ds/HjTLILDrgh?key=G4TNkhGtJv" > roboflow.zip; unzip roboflow.zip; rm roboflow.zip
